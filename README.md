...
- два новых отчета (по операторам за дни и детальный)
- добавлена возможность пополнять банк (деньги) кассы
- обновлена функция обмена (если в кассе недостаточно средств)
